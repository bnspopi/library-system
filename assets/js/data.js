...
(function (global) {
  ...
  /* The collections — the halls a reader walks between. Every
     bibliographic record belongs to exactly one. */
  var COLLECTIONS = [
    { key: 'kids',        n: '01', name: 'Children’s Wing',   hall: 'The Nursery Shelves',
      blurb: 'Picture books, first readers and the stories that get read aloud four hundred times.' },
    { key: 'adult',       n: '02', name: 'Adult Hall',        hall: 'The Quiet Stacks',
      blurb: 'Fiction, memoir and the long novels that take a winter.' },
    { key: 'voyages',     n: '03', name: 'Voyages',           hall: 'The Expedition Room',
      blurb: 'Sea stories, expeditions, maps, and everyone who ever left home.' },
    { key: 'science',     n: '04', name: 'Science',           hall: 'The Observatory',
      blurb: 'Cosmology, anatomy, the mind, and how we know what we know.' },
    { key: 'technology',  n: '05', name: 'Technology',        hall: 'The Living Stacks',
      blurb: 'Algorithms, craft, design, and the machines we made.' },
    { key: 'history',     n: '06', name: 'History',           hall: 'The Reading Room',
      blurb: 'Nations, arguments and the people who wrote them down.' },
    { key: 'ancient',     n: '07', name: 'Ancient',           hall: 'The Atlas Vault',
      blurb: 'The oldest voices: chronicles, treatises and epics of the first cities.' },
    { key: 'civilization',n: '08', name: 'Civilization',      hall: 'The Great Book',
      blurb: 'How we organised ourselves — money, law, and the story of the species.' },
    { key: 'mythology',   n: '09', name: 'Mythology',         hall: 'The Hall of Gods',
      blurb: 'Epics, gods and the stories older than the alphabets they are written in.' },
    { key: 'horror',      n: '10', name: 'Horror',            hall: 'The Closed Wing',
      blurb: 'Gothic novels, ghost stories, and the shelf that is kept chained.' }
  ];
  ...
  var BIBS = [
    { collection: 'technology', title: 'The Design of Everyday Things', author: 'Norman, Donald A.',
    ...
    { collection: 'civilization', title: 'Sapiens: A Brief History of Humankind', author: 'Harari, Yuval Noah',
    ...
    { collection: 'technology', title: 'Introduction to Algorithms', author: 'Cormen, Thomas H.',
    ...
    { collection: 'adult', title: 'Things Fall Apart', author: 'Achebe, Chinua',
    ...
    { collection: 'history', title: 'The Argumentative Indian', author: 'Sen, Amartya',
    ...
    { collection: 'adult', title: 'Midnight’s Children', author: 'Rushdie, Salman',
    ...
    { collection: 'technology', title: 'Clean Code: A Handbook of Agile Software Craftsmanship', author: 'Martin, Robert C.',
    ...
    { collection: 'adult', title: 'The Namesake', author: 'Lahiri, Jhumpa',
    ...
    { collection: 'science', title: 'A Brief History of Time', author: 'Hawking, Stephen W.',
    ...
    { collection: 'adult', title: 'Train to Pakistan', author: 'Singh, Khushwant',
    ...
    { collection: 'science', title: 'Thinking, Fast and Slow', author: 'Kahneman, Daniel',
    ...
    { collection: 'adult', title: 'The God of Small Things', author: 'Roy, Arundhati',
    ...
    { collection: 'civilization', title: 'Principles of Economics', author: 'Mankiw, N. Gregory',
    ...
    { collection: 'science', title: 'Gray’s Anatomy for Students', author: 'Drake, Richard L.',
    ...
    { collection: 'history', title: 'The Discovery of India', author: 'Nehru, Jawaharlal',
    ...
    { collection: 'adult', title: 'Norwegian Wood', author: 'Murakami, Haruki',
    ...
    { collection: 'civilization', title: 'Law of Contract and Specific Relief', author: 'Singh, Avtar',
    ...
    { collection: 'adult', title: 'Educated: A Memoir', author: 'Westover, Tara',
    ...
    { collection: 'history', title: 'The Wonder That Was India', author: 'Basham, A. L.',
    ...
    { collection: 'technology', title: 'Blade Runner 2049', author: 'Villeneuve, Denis (dir.)',
    ...
    { collection: 'technology', title: 'Loan Laptop — ThinkPad T14 (4-hour)', author: 'Aurelia Library IT Services',
    ...
    /* --- children's wing --- */
    { collection: 'kids', title: 'Alice’s Adventures in Wonderland', author: 'Carroll, Lewis',
      isbn: '9780141439761', publisher: 'Penguin Classics', year: 2012, lang: 'English',
      subjects: ['Fantasy fiction', 'Children’s stories', 'Nonsense literature'],
      dewey: 'J 823.8 CAR', format: 'Book',
      summary: 'A girl follows a white rabbit down a hole and finds a world that argues back.',
      copies: [['MAIN', 'BOOK', 'available', 3], ['NORTH', 'BOOK', 'available', 2]] },
    { collection: 'kids', title: 'The Jungle Book', author: 'Kipling, Rudyard',
      isbn: '9780141325293', publisher: 'Puffin Classics', year: 2008, lang: 'English',
      subjects: ['Animals — Fiction', 'India — Fiction', 'Children’s stories'],
      dewey: 'J 823.8 KIP', format: 'Book',
      summary: 'Mowgli, raised by wolves in the Seeonee hills, learns the Law of the Jungle.',
      copies: [['MAIN', 'BOOK', 'available', 2], ['NORTH', 'BOOK', 'available', 2]] },
    { collection: 'kids', title: 'The Blue Umbrella', author: 'Bond, Ruskin',
      isbn: '9788129108708', publisher: 'Rupa', year: 2012, lang: 'English',
      subjects: ['Himalaya — Fiction', 'Children’s stories', 'Kindness'],
      dewey: 'J 823.914 BON', format: 'Book',
      summary: 'Binya trades her lucky leopard-claw pendant for a blue umbrella, and the whole village wants it.',
      copies: [['MAIN', 'BOOK', 'available', 2], ['NORTH', 'BOOK', 'available', 1]] },

    /* --- voyages --- */
    { collection: 'voyages', title: 'Treasure Island', author: 'Stevenson, Robert Louis',
      isbn: '9780141321004', publisher: 'Puffin Classics', year: 2008, lang: 'English',
      subjects: ['Pirates — Fiction', 'Sea stories', 'Adventure'],
      dewey: '823.8 STE', format: 'Book',
      summary: 'A map, a one-legged cook, and a boy who should not have been listening.',
      copies: [['MAIN', 'BOOK', 'available', 2], ['NORTH', 'BOOK', 'available', 1]] },
    { collection: 'voyages', title: 'Twenty Thousand Leagues Under the Seas', author: 'Verne, Jules',
      isbn: '9780199539277', publisher: 'Oxford World’s Classics', year: 2009, lang: 'English',
      subjects: ['Submarines — Fiction', 'Sea stories', 'Science fiction'],
      dewey: '843.8 VER', format: 'Book',
      summary: 'Captain Nemo and the Nautilus, and the ocean as nobody had imagined it.',
      copies: [['MAIN', 'BOOK', 'available', 2]] },
    { collection: 'voyages', title: 'Moby-Dick; or, The Whale', author: 'Melville, Herman',
      isbn: '9780142437247', publisher: 'Penguin Classics', year: 2003, lang: 'English',
      subjects: ['Whaling — Fiction', 'Sea stories', 'Obsession'],
      dewey: '813.3 MEL', format: 'Book',
      summary: 'Call him Ishmael. Then follow a captain who will not turn back.',
      copies: [['MAIN', 'BOOK', 'available', 2], ['LAW', 'BOOK', 'available', 1]] },

    /* --- ancient --- */
    { collection: 'ancient', title: 'The Histories', author: 'Herodotus',
      isbn: '9780140449082', publisher: 'Penguin Classics', year: 2003, lang: 'English',
      subjects: ['Greece — History', 'Persian Wars', 'Historiography'],
      dewey: '930 HER', format: 'Book',
      summary: 'The first inquiry — why the Greeks and the Persians went to war, and everything the author heard along the way.',
      copies: [['MAIN', 'BOOK', 'available', 2]] },
    { collection: 'ancient', title: 'The Arthashastra', author: 'Kautilya',
      isbn: '9780140446036', publisher: 'Penguin Classics', year: 1992, lang: 'English',
      subjects: ['Statecraft — India', 'Political science — Early works', 'Mauryan Empire'],
      dewey: '320.954 KAU', format: 'Book',
      summary: 'A fourth-century BCE manual on running a state: taxation, espionage, war and the price of grain.',
      copies: [['MAIN', 'BOOK', 'available', 1], ['LAW', 'REF', 'reference', 1]] },
    { collection: 'ancient', title: 'The Epic of Gilgamesh', author: 'Anonymous',
      isbn: '9780140449198', publisher: 'Penguin Classics', year: 2003, lang: 'English',
      subjects: ['Epic poetry, Assyro-Babylonian', 'Mesopotamia', 'Mortality'],
      dewey: '892.1 GIL', format: 'Book',
      summary: 'A king, a wild man, and the oldest story about not wanting to die.',
      copies: [['MAIN', 'BOOK', 'available', 2]] },

    /* --- mythology --- */
    { collection: 'mythology', title: 'The Odyssey', author: 'Homer',
      isbn: '9780393356250', publisher: 'W. W. Norton', year: 2018, lang: 'English',
      subjects: ['Epic poetry, Greek', 'Odysseus (Greek mythology)', 'Homecoming'],
      dewey: '883.01 HOM', format: 'Book',
      summary: 'Ten years to get home from a war, and every god with an opinion about it.',
      copies: [['MAIN', 'BOOK', 'available', 3], ['NORTH', 'BOOK', 'available', 1]] },
    { collection: 'mythology', title: 'The Ramayana: A Shortened Modern Prose Version', author: 'Narayan, R. K.',
      isbn: '9780143039679', publisher: 'Penguin Classics', year: 2006, lang: 'English',
      subjects: ['Valmiki. Ramayana', 'Hindu mythology', 'Epic literature — India'],
      dewey: '294.5922 NAR', format: 'Book',
      summary: 'Rama, Sita, Hanuman and the long road to Lanka, told in one evening.',
      copies: [['MAIN', 'BOOK', 'available', 2], ['NORTH', 'BOOK', 'available', 1]] },
    { collection: 'mythology', title: 'Metamorphoses', author: 'Ovid',
      isbn: '9780140447897', publisher: 'Penguin Classics', year: 2004, lang: 'English',
      subjects: ['Mythology, Classical — Poetry', 'Metamorphosis', 'Latin poetry'],
      dewey: '873.01 OVI', format: 'Book',
      summary: 'Two hundred and fifty transformations, from chaos to the death of Caesar.',
      copies: [['MAIN', 'BOOK', 'available', 1]] },

    /* --- horror: the closed wing --- */
    { collection: 'horror', title: 'Dracula', author: 'Stoker, Bram',
      isbn: '9780141439846', publisher: 'Penguin Classics', year: 2003, lang: 'English',
      subjects: ['Vampires — Fiction', 'Gothic fiction', 'Transylvania'],
      dewey: '823.8 STO', format: 'Book',
      summary: 'Letters, diaries and a ship’s log, and the thing that came ashore at Whitby.',
      copies: [['MAIN', 'BOOK', 'available', 2], ['NORTH', 'BOOK', 'available', 1]] },
    { collection: 'horror', title: 'Frankenstein; or, The Modern Prometheus', author: 'Shelley, Mary',
      isbn: '9780141439471', publisher: 'Penguin Classics', year: 2003, lang: 'English',
      subjects: ['Gothic fiction', 'Scientists — Fiction', 'Monsters'],
      dewey: '823.7 SHE', format: 'Book',
      summary: 'A student assembles a creature and then refuses to look at it.',
      copies: [['MAIN', 'BOOK', 'available', 2]] },
    { collection: 'horror', title: 'The Turn of the Screw', author: 'James, Henry',
      isbn: '9780141441351', publisher: 'Penguin Classics', year: 2011, lang: 'English',
      subjects: ['Ghost stories', 'Governesses — Fiction', 'Psychological fiction'],
      dewey: '813.4 JAM', format: 'Book',
      summary: 'A governess, two children, and two figures who may or may not be there.',
      copies: [['MAIN', 'BOOK', 'available', 1], ['NORTH', 'BOOK', 'available', 1]] },

    { collection: 'technology', title: 'Digital Minimalism', author: 'Newport, Cal',
  ...
  function buildSeed() {
    ...
    var db = {
      ...
      collections: U.clone(COLLECTIONS),
    ...
    BIBS.forEach(function (b, bi) {
      ...
      var bib = {
        id: bibId, collection: b.collection || 'adult',
